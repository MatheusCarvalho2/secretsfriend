...
class MatchFriend < ApplicationRecord # rubocop:disable Style/Documentation
  belongs_to :draw
  has_many :first_participant, class_name: 'Draw', foreign_key: 'participant1_id', dependent: :destroy
  has_many :second_participant, class_name: 'Draw', foreign_key: 'participant2_id', dependent: :destroy
